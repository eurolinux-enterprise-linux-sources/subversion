...
Patch9: subversion-1.6.11-authzuname.patch
Patch10: subversion-1.6.11-r934494.patch
...
Patch24: subversion-1.6.11-CVE-2011-1752.patch
Patch25: subversion-1.6.11-CVE-2011-1921.patch
...
%endif
%patch8 -p1 -b .kwallet
%patch9 -p1 -b .authzuname
%patch10 -p1 -b .r934494
...
%patch24 -p1 -b .cve1752
%patch25 -p1 -b .cve1921
...
* Tue Apr 10 2012 Joe Orton <jorton@redhat.com> - 1.6.11-6
- fix return value for non-root "start" in svnserve.init (#711904)

* Wed Feb 29 2012 Joe Orton <jorton@redhat.com> - 1.6.11-5
- add init script for svnserve (#720790, #711904)
- fix segfault with "AuthzForceUsernameCase lower" (#751321)
- fix parent directory access with merges (#749494)

* Fri Jun 24 2011 Joe Orton <jorton@redhat.com> - 1.6.11-4
- add security fixes for CVE-2011-1752, CVE-2011-1783, CVE-2011-1921 (#709221)
- add security fix for CVE-2011-0715 (#681174)
- add security fixes for CVE-2010-4644, CVE-2010-4539 (#672679)

* Wed Oct 13 2010 Joe Orton <jorton@redhat.com> - 1.6.11-3
- add security fix for CVE-2010-3315 (#640323)
